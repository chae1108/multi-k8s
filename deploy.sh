...
docker push chae1108/mult-client:latest
docker push chae1108/mult-server:latest
docker push chae1108/mult-worker:latest

docker push chae1108/mult-client:$SHA
docker push chae1108/mult-server:$SHA
docker push chae1108/mult-worker:$SHA
